...
STYLE_PATTERNS = {
    ...
    # === AMMO TYPES ===
    "primary_ammo": {
        "pattern": r'\bPrimary (?:Ammo(?: (?:Reserves?|Weapons?))?|Weapons?)\b',
        "class": "primary",
        "flags": re.IGNORECASE,
        "description": "Primary ammo type"
    },
    "special_ammo": {
        "pattern": r'\bSpecial(?: (?:Ammo(?: (?:Reserves?|Weapons?))?|Weapons?))?\b',
        "class": "special",
        "flags": re.IGNORECASE,
        "description": "Special ammo type"
    },
    "heavy_ammo": {
        "pattern": r'\b(?:Heavy|Power) (?:(?:Ammo|Weapon)s?(?: (?:Reserves?))?|Bricks?)\b',
        "class": "heavy",
        "flags": re.IGNORECASE,
...
STYLES_ORDER = [
    ...
    #Pattern dynamique du nom de l'item
    "perk_name_reference",
