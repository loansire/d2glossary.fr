...
STYLE_PATTERNS = {
    ...
    "scout_rifle": {
        "pattern": r'\b(?:(?:High-Impact|Lightweight|Rapid-Fire|Rocket|Non-Burst|\d{3}RPM(?: and \d{3}RPM)*) )?Scout Rifles?\b',
    ...
    "submachine_gun": {
        "pattern": r'\b(?:(?:(?:High-Impact|Lightweight|Rapid-Fire|Rocket|Non-Burst|\d{3}RPM(?: and \d{3}RPM)*) )?Submachine Guns?|SMGs?)\b',
        "class": "weapon-smg",
        "description": "Submachine Gun weapon type"
    },
    "bow": {
        "pattern": r'\b(?:(?:High-Impact|Lightweight|Rapid-Fire|Rocket|Non-Burst|\d{3}RPM(?: and \d{3}RPM)*) )?Bows?\b',
        "class": "weapon-bow",
    ...
    "shotgun": {
        "pattern": r'\b(?:(?:High-Impact|Lightweight|Rapid-Fire|Rocket|Non-Burst|\d{3}RPM(?: and \d{3}RPM)*) )?Shotguns?\b',
        "class": "weapon-shotgun",
        "description": "Shotgun weapon type"
    },
    "trace_rifle": {
        "pattern": r'\b(?:(?:High-Impact|Lightweight|Rapid-Fire|Rocket|Non-Burst|\d{3}RPM(?: and \d{3}RPM)*) )?Trace Rifles?\b',
        "class": "weapon-trace-rifle",
        "description": "Trace Rifle weapon type"
    },
    "glaive": {
        "pattern": r'\b(?:(?:High-Impact|Lightweight|Rapid-Fire|Rocket|Non-Burst|\d{3}RPM(?: and \d{3}RPM)*) )?Glaives?\b',
        "class": "weapon-glaive",
